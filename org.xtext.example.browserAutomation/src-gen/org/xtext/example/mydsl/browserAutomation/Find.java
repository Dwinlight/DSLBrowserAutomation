 ...
 *   <li>{@link org.xtext.example.mydsl.browserAutomation.Find#getS <em>S</em>}</li>
...
public interface Find extends EObject
{
   ...
   * @see #setS(String)
   * @see org.xtext.example.mydsl.browserAutomation.BrowserAutomationPackage#getFind_S()
   * @model
   * @generated
   */
  String getS();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.browserAutomation.Find#getS <em>S</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
